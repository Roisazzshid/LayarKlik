<%-- 
    Document   : register
    Created on : Dec 31, 2025, 1:54:21 PM
    Author     : USER
--%>
<% if(request.getParameter("error") != null) { %>
    <div class="bg-red-500/10 border border-red-500/50 text-red-500 text-[10px] p-3 rounded-xl mb-6 text-center font-bold uppercase tracking-widest">
...
<html>
    <head>
        ...
        <title>LayarKlik - Register</title>
    </head>
    <body>
        <div class="min-h-screen flex items-center justify-center p-6 relative" 
           ...
           <div class="relative w-full max-w-md z-10">
               ...
               <div class="relative bg-slate-900/90 backdrop-blur-2xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                   ...
                   <form action="RegisterProcessServlet" method="POST" class="space-y-6">
                       <div>
                   ...
                   <div class="mt-8 text-center text-sm">
                       <p class="text-slate-400">
                           Sudah punya akun? 
                           <a href="login.jsp" class="text-blue-400 font-bold hover:text-blue-300 transition-colors">Login Sekarang</a>
                       </p>
                       <a href="index.jsp" 
